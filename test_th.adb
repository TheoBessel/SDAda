...
procedure Test_TH is
	...
	package TH_String_Integer is
		new TH (T_Cle => Unbounded_String, T_Valeur => Integer, V_Capacity => 10, F_Hash => Hash);
	use TH_String_Integer;


	-- Retourner une chaî       ne avec des guillemets autour de S
	...
	procedure Construire_Exemple_Sujet (Annuaire : out T_TH) is
	begin
